...
def run_input_node(args):
    ...
    ROSImageListenNRenderer(display_man, 'ROSSubimage', {'ros_topic':'/carla_node/cam_overview/image_raw'}, display_pos=[2, 0], display_scale=1)
    ...
    #ROSImageListenNRenderer(display_man, 'ROSSubimage', {'ros_topic':'/carla_node/cam_down/image_raw'}, display_pos=[2, 2])

    # YOLO experts
    ROSImageListenNRenderer(display_man, 'ROSSubimage', {'ros_topic':'/yolo_node/yolo_small_frame'}, display_pos=[0, 2])
    ROSImageListenNRenderer(display_man, 'ROSSubimage', {'ros_topic':'/yolo_node/yolo_large_frame'}, display_pos=[0, 1])

    # SORT trackers
    ROSImageListenNRenderer(display_man, 'ROSSubimage', {'ros_topic':'/yolo_node/sort_small_frame'}, display_pos=[2, 2])
    ROSImageListenNRenderer(display_man, 'ROSSubimage', {'ros_topic':'/yolo_node/sort_large_frame'}, display_pos=[2, 1])

    # Fusion
    ROSImageListenNRenderer(display_man, 'ROSSubimage', {'ros_topic':'/yolo_node/fused_frame'}, display_pos=[0, 0])

    # Planner/map (keep at 0,0)
